...
export class MediaComponent implements OnInit {
  ...
  trackId = (item: IMedia): number => this.mediaService.getMediaIdentifier(item);
      ...
      .pipe(
        ...
        tap(() => {
          if (this.media().length === 0) {
            ...
            this.media.set(this.refineData(this.media()));
          }
        }),
      )
      .subscribe();
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.media.set(this.refineData(dataFromBody));
  }
