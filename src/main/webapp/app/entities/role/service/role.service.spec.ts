...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../role.test-samples';

import { RestRole, RoleService } from './role.service';

const requireRestSample: RestRole = {
