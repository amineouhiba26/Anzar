...
export class PropertyComponent implements OnInit {
  ...
  trackId = (item: IProperty): number => this.propertyService.getPropertyIdentifier(item);
      ...
      .pipe(
        ...
        tap(() => {
          if (this.properties().length === 0) {
            ...
            this.properties.set(this.refineData(this.properties()));
          }
        }),
      )
      .subscribe();
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.properties.set(this.refineData(dataFromBody));
  }

  protected refineData(data: IProperty[]): IProperty[] {
