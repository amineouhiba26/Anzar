...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../property.test-samples';

import { PropertyService, RestProperty } from './property.service';

const requireRestSample: RestProperty = {
