...
import { sampleWithRequiredData } from '../custom-user.test-samples';
...
describe('CustomUser Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.customUsers()[0]).toEqual(expect.objectContaining({ id: 11466 }));
  });
