...
import { sampleWithRequiredData } from '../attribute-value.test-samples';
...
describe('AttributeValue Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.attributeValues()[0]).toEqual(expect.objectContaining({ id: 32470 }));
  });

  describe('trackId', () => {
    it('Should forward to attributeValueService', () => {
      const entity = { id: 32470 };
      jest.spyOn(service, 'getAttributeValueIdentifier');
      const id = comp.trackId(entity);
      expect(service.getAttributeValueIdentifier).toHaveBeenCalledWith(entity);
