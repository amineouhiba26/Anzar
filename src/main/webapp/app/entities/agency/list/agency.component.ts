...
export class AgencyComponent implements OnInit {
  ...
  trackId = (item: IAgency): number => this.agencyService.getAgencyIdentifier(item);
      ...
      .pipe(
        ...
        tap(() => {
          if (this.agencies().length === 0) {
            ...
            this.agencies.set(this.refineData(this.agencies()));
          }
        }),
      )
      .subscribe();
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.agencies.set(this.refineData(dataFromBody));
  }
